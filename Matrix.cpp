...
{ cout << x.coloumnsNumbers << "-----------------" << x.rowsNumbers << endl;
...
CMatrix& CMatrix::getTranspose()
	{
		//CMatrix r=*this;
		//cout << "input in transpose"<<endl<<r<<endl;
		static CMatrix r("",this->coloumnsNumbers,this->rowsNumbers,0,0);
		cout << "input in transpose"<<endl<<r.coloumnsNumbers << "" <<r.rowsNumbers<<endl;
		for(int iR=0;iR<rowsNumbers;iR++)
		{
			for(int iC=0;iC<coloumnsNumbers;iC++)
			{
